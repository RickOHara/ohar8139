...
/**
 * 
 * Creates a graph based on the goals and beacons and other objects in the spacewar space. 
 * 
 * @author Dr. McGovern
 *
 */
public class Graph {
	...
	public Vector<Shadow> getShadows() {
		Vector<Shadow> shadows = new Vector<Shadow>();

		for (int v = 0; v < vertices.size(); v++) {
			Shadow shadow = ((Vertex)vertices.get(v)).getShadow();
			shadows.add(shadow);
		}

		for (int e = 0; e < edges.size(); e++) {
			Shadow shadow = ((Edge)edges.get(e)).getShadow();
			shadows.add(shadow);
		}
